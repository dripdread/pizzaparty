...
class person{
public:
  person(string full_name, int nhs_number) :
    name(full_name), nhs(nhs_number)
    {
...
public:
  student(string full_name, int nhs_number, int student_id) :
    student_id(student_id),
    person(full_name, nhs_number) // call constructor of parent class person
    {
